...
/* ========== SIDEBAR — sama persis dengan pos.php ========== */
.sidebar{
...
<!-- ========== SIDEBAR (sama dengan pos.php) ========== -->
<div class="sidebar" id="sidebar">
  <div class="sidebar-logo">🍜 Seoullicious</div>
  <a href="home.php"     class="nav-item"><i class="fas fa-utensils"></i> Menu</a>
  <a href="history.php" class="nav-item active"><i class="fas fa-clock-rotate-left"></i> History</a>
...
<script>
/* Toggle sidebar — sama dengan pos.php */
