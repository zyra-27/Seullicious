...
/* ========== MAIN ========== */
/* PERUBAHAN: flex:1 penuh karena order-panel dihilangkan */
...
/* ========== MENU GRID ==========
   PERUBAHAN: repeat(5,1fr) → selalu 5 kolom penuh (sebelumnya auto-fill minmax 160px)
*/
.menu-grid{
  display:grid;
  grid-template-columns:repeat(5,1fr); /* ← DIUBAH: paksa 5 kolom */
  gap:16px;
}
.menu-card{
...
.menu-card:hover{transform:translateY(-3px);box-shadow:0 8px 20px rgba(139,90,26,0.12);}
.menu-card img{
  width:100px;height:100px;object-fit:cover;
  object-position:center;border-radius:12px;
  background:#f5f0e8;display:block;margin:0 auto;
}
/* PERUBAHAN: font dibesarkan */
.menu-card h4{font-size:15px;font-weight:700;color:#2d1a08;margin:10px 0 4px;} /* ← 13px → 15px */
.menu-card p{font-size:14px;color:#8b5a1a;font-weight:600;margin-bottom:10px;}  /* ← 12px → 14px */
.add-btn{
  background:linear-gradient(135deg,#8b5a1a,#c28b3c);
  color:white;border:none;padding:7px 18px;
  border-radius:8px;cursor:pointer;font-size:14px;font-weight:600; /* ← 13px → 14px */
...
/* ==========================================================
   ...
   PERUBAHAN: tombol keranjang mengambang di pojok kanan bawah
   menggantikan sidebar order-panel yang dihilangkan
========================================================== */
#cart-float-btn{
...
/* ==========================================================
   ...
   PERUBAHAN: order panel dipindah ke modal overlay
========================================================== */
...
<!--
  ============================================================
  PERUBAHAN: Order panel lama DIHAPUS dari sini.
  Digantikan oleh floating button + modal di bawah.
  ============================================================
-->
...
/* PERUBAHAN: update floating cart button */
...
/* PERUBAHAN: buka/tutup modal checkout */
...
/* PERUBAHAN: checkout sekarang tutup modal dulu, baru redirect */
function checkout(){
